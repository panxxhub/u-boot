...
unsigned long ps7_ocm_init_data[] = {
    EMIT_WRITE(0XF8000008, 0x0000DF0DU),
    EMIT_MASKWRITE(0xF8000910, 0x0000000FU, 0x0000000FU),
    EMIT_WRITE(0XF8000004, 0x0000767BU),
    EMIT_MASKWRITE(0xF8F00040, 0xFFFFFFFFU, 0x00000000U),
    EMIT_MASKWRITE(0xF8F00044, 0xFFFFFFFFU, 0xFFE00000U),
    // mpcore.SCU_CONTROL_REGISTER[Address_filtering_enable] = 1 // bit 1
    EMIT_MASKWRITE(0xF8F00000, 0x00000002U, 0x00000002U),
    EMIT_EXIT(),
};
...
unsigned long ps7_post_config_data[] = {
    // START: top
    // .. START: SLCR SETTINGS
    // .. UNLOCK_KEY = 0XDF0D
    // .. ==> 0XF8000008[15:0] = 0x0000DF0DU
...
int ps7_post_config() {
  int ret = -1;
  ret = ps7_config(ps7_post_config_data);
